define(function (require) {
    ...
    var _                   = require('underscore'),
        ...
        tpl                 = require('text!tpl/MultipleNotifications.html'),
    ...
    return Backbone.View.extend({
        ...
        switchClicked:function (event) {  
            ...
            console.log('attribute id is ');
            console.log($(event.currentTarget).attr('id'));
            
            var checked = $(event.currentTarget).is(":checked");
            
            this.model.set($(event.currentTarget).attr('id'), 1);
            ...
            if(checked===true){
                    ...
                    if(typeof(this.model.id)==='undefined' || this.model.id===null){
                        ...
                        this.model.set($(event.currentTarget).attr('id'), 0);
